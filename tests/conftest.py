                    ...
                    "content": json.dumps({
                        "warmup": {
                            ...
                            "exercises": [{
                                ...
                                "rest_time": "0 seconds",
                                "intensity": "low",
                                "technique_tips": ["Keep arms straight", "Control the movement"]
                            }],
                            "instructions": ["Start slowly", "Increase intensity gradually"]
                        },
                        "main_workout": {
                            "duration": "30 minutes",
                            "exercises": [{
                                ...
                                "intensity": "moderate",
                                "technique_tips": ["Keep body straight", "Full range of motion"],
                                "modifications": {"beginner": "Knee push-ups", "advanced": "Diamond push-ups"}
                            }],
                            "instructions": ["Focus on form", "Control the movement"]
                        },
                        "cooldown": {
                            "duration": "10 minutes", 
                            "exercises": [{
                                ...
                                "rest_time": "0 seconds",
                                "intensity": "low",
                                "technique_tips": ["Hold each stretch", "Breathe deeply"]
                            }],
                        ...
                        "progression_notes": ["Start with bodyweight", "Increase reps weekly"],
                        "nutrition_tips": [{
                            "category": "pre_workout",
                            "recommendation": "Eat a light snack 30 minutes before",
                            "timing": "30 minutes before"
                        }],
                        "recovery_recommendations": ["Rest 48 hours between sessions", "Stay hydrated"],
...
def openai_mock_nutrition(openai_mock):
    ...
    nutrition_response = {
        ...
        "meals": [
            {
                ...
                "preparation_time": 10,
                "instructions": ["Mix oats with almond milk", "Add banana and protein powder", "Stir well"],
            ...
            },
            {
                ...
                "preparation_time": 25,
                "instructions": ["Cook chicken breast", "Prepare quinoa", "Steam vegetables"],
        ...
        "shopping_list": ["chicken breast", "salmon", "quinoa", "sweet potato", "broccoli", "oats", "banana", "almond milk", "protein powder"],
        ...
        "nutrition_education": ["Focus on whole foods", "Stay hydrated", "Balance macronutrients"],
        ...
        "adjustment_guidelines": ["Adjust portions based on progress", "Monitor energy levels", "Stay consistent"]
    }
    ...
    openai_mock.post("/v1/chat/completions").respond(
        ...
        json={
            "choices": [{
                "message": {
                    "content": json.dumps(nutrition_response)
                }
            }]
        }
    )
...
def openai_mock_tips(openai_mock):
    ...
    tips_response = {
        "tips": [
            {
                ...
                "action_steps": ["Start with 10-minute walks", "Add 5 minutes weekly", "Track your progress"],
                "benefits": ["Builds habit", "Reduces overwhelm", "Increases confidence"],
                ...
                "progression_tips": ["Increase duration before intensity", "Listen to your body"]
            },
            {
                "title": "Hydrate First",
                "category": "nutrition",
                ...
                "action_steps": ["Drink 500ml upon waking", "Have water before meals", "Carry a water bottle"],
                "benefits": ["Better digestion", "Reduced hunger", "Improved energy"],
                "common_mistakes": ["Waiting until thirsty", "Drinking too much with meals"],
                "scientific_rationale": "Proper hydration supports metabolic function",
                "progression_tips": ["Add electrolytes if active", "Monitor urine color"]
            },
            {
                ...
                "action_steps": ["Set fixed bedtime", "Create bedtime ritual", "Avoid screens 1 hour before bed"],
                "benefits": ["Better recovery", "Improved mood", "Enhanced performance"],
            ...
            },
            {
                ...
                "action_steps": ["Write specific goals", "Set measurable targets", "Create timeline"],
        ...
        "implementation_strategy": {
            ...
            "key_principles": ["Consistency over perfection", "Start small", "Track progress"]
        },
        "priority_order": ["Start Small", "Hydrate First", "Sleep Schedule", "Goal Setting"],
        "tracking_methods": ["Daily habit tracker", "Weekly check-ins", "Progress photos"],
        "success_indicators": ["Increased energy", "Better mood", "Consistent habits"],
        "related_concepts": ["Habit formation", "Progressive overload", "Recovery optimization"],
        "advanced_techniques": ["Periodization", "Advanced nutrition timing", "Biohacking techniques"],
        "common_obstacles": ["Time constraints", "Lack of motivation", "Social pressure"],
        "motivation_strategies": ["Find accountability partner", "Celebrate small wins", "Focus on how you feel"]
    }
    ...
    openai_mock.post("/v1/chat/completions").respond(
        ...
        json={
            "choices": [{
                "message": {
                    "content": json.dumps(tips_response)
                }
            }]
        }
    )
