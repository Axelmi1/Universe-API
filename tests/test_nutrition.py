...
class TestNutritionGeneration:
    ...
    @pytest.mark.asyncio
    async def test_nutrition_generation_success(self, async_client, openai_mock_nutrition, valid_headers):
        ...
        required_keys = ["daily_calories", "daily_macros", "meals", "weekly_meal_prep", "shopping_list"]
    ...
    @pytest.mark.asyncio
    async def test_nutrition_generation_validation_error_age(self, async_client, valid_headers):
    ...
    @pytest.mark.asyncio
    async def test_nutrition_generation_validation_error_weight(self, async_client, valid_headers):
    ...
    @pytest.mark.asyncio
    async def test_nutrition_generation_with_restrictions(self, async_client, openai_mock_nutrition, valid_headers):
    ...
    @pytest.mark.asyncio
    async def test_nutrition_generation_athlete_profile(self, async_client, openai_mock_nutrition, valid_headers):
    ...
    @pytest.mark.asyncio
    async def test_nutrition_structure_validation(self, async_client, openai_mock_nutrition, valid_headers):
        ...
        for meal in meals:
            required_fields = ["name", "time", "calories", "macros", "ingredients", "preparation_time", "instructions", "tips"]
            for field in required_fields:
                assert field in meal, f"Missing field {field} in meal"

    @pytest.mark.asyncio
    async def test_nutrition_generation_with_health_conditions(self, async_client, openai_mock_nutrition, valid_headers):
...
class TestNutritionMetadata:
    ...
    async def test_get_dietary_preferences(self, async_client):
        ...
        response = await async_client.get("/api/v1/metadata/nutrition/dietary-preferences")
